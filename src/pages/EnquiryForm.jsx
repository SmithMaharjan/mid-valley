  ...
  return (
    <>
      <div className="min-h-screen pt-[350px] flex flex-wrap justify-center items-start gap-20 bg-white">
        ...
        <motion.div
          className="absolute top-5 left-5 bg-white backdrop-blur rounded-[54px] p-4 shadow-xl border-6 border-orange-500 z-[100]"
        ...
        >
          ...
          <motion.img
            src="/logo.png"
            alt="Logo"
            className="  lg:h-[70px] md:h-[53px] sm:h-[40px] "
        ...
        <motion.div
          className="absolute top-[80px] left-[120px] right-[120px] px-5 text-blue-900 text-center text-xl"
        ...
        <motion.div
          className="fixed top-5 lg:right-5  md:right-25 sm:right-20 bg-white/40 backdrop-blur rounded-xl p-4 shadow-xl border-6 border-orange-500 z-[1000] cursor-pointer"
          initial={{ opacity: 0, x: 100 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 2 }}
        >
          <motion.div
            className="text-orange-500 text-xl select-none "
            whileTap={{ scale: 2 }}
